...
-- Verificar se o usuário "gustavo_schade" já existe, se existir, então eu devo excluir.
...
COMMENT ON COLUMN loja_id                 IS 'Criar a coluna "loja_id", na qual ela é a Primary Key.';
COMMENT ON COLUMN nome                    IS 'Criar a coluna "nome".';
COMMENT ON COLUMN endereco_web            IS 'Criar a coluna "endereco_web".';
COMMENT ON COLUMN endereco_fisico         IS 'Criar a coluna "endereco_fisico".';
COMMENT ON COLUMN latitude                IS 'Criar a coluna "latitude".';
COMMENT ON COLUMN longitude               IS 'Criar a coluna "longitude".';
COMMENT ON COLUMN logo                    IS 'Criar a coluna "logo".';
COMMENT ON COLUMN logo_mime_type          IS 'Criar a coluna "logo_mime_type".';
COMMENT ON COLUMN logo_arquivo            IS 'Criar a coluna "logo_arquivo".';
COMMENT ON COLUMN logo_charset            IS 'Criar a coluna "logo_charset".';
COMMENT ON COLUMN logo_ultima_atualizacao IS 'Criar a coluna "logo_ultima_atualizacao".';
...
COMMENT ON COLUMN envios.envio_id         IS 'Criar a coluna "envio_id", na qual é a Primary Key.';
COMMENT ON COLUMN envios.loja_id          IS 'Criar a coluna "loja_id", na qual é uma FK.';
...
COMMENT ON COLUMN pedidos.cliente_id IS 'Criar a coluna "cliente_id", na qual ela é FK.';
