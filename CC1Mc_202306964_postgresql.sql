	...
	CREATE USER gustavo_schade WITH CREATEDB
	  CREATEROLE  
	  ENCRYPTED PASSWORD '123';
	
	-- Depois, criar o banco de dados.S
	...
	CREATE SCHEMA IF NOT EXISTS lojas AUTHORIZATION gustavo_schade;
	ALTER USER gustavo_schade SET search_path TO lojas ,'$user', public;
